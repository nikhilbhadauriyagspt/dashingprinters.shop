      ...
      <div className="max-w-full mx-auto px-6 lg:px-12 lg:py-20 relative z-10 w-full">
        <div className="max-w-2xl text-white">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-[12px] font-black text-[#10b981] uppercase tracking-[3px]">Enterprise solutions</span>
          </div>
          ...
          <Link to="/contact" className="group inline-flex items-center gap-4 py-3 px-10 bg-[#10b981] text-white rounded-full font-black text-sm uppercase tracking-widest hover:bg-[#059669] transition-all shadow-2xl shadow-[#10b981]/20">
