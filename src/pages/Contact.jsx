...
export default function Contact() {
  ...
  return (
    <div className="bg-white min-h-screen font-['Heebo'] text-slate-900 pb-20">
      <SEO
        title="Contact Us | Optimum Prints Support"
        description="Connect with the Optimum Prints team for support, orders, or hardware inquiries."
      />
      ...
      <div className="bg-slate-50 border-b border-slate-100 py-12 md:py-16 mb-16">
        <div className="max-w-full mx-auto px-6 lg:px-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex items-center gap-3 px-5 py-2.5 bg-white text-[#10b981] rounded-2xl border border-slate-100 shadow-sm">
            <Headphones size={18} />
      ...
      <div className="max-w-full mx-auto px-6 lg:px-12 mt-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="p-10 bg-slate-50 border border-slate-100 rounded-[2.5rem] group hover:bg-white hover:border-[#10b981]/20 transition-all duration-500">
              <div className="h-14 w-14 bg-white rounded-2xl flex items-center justify-center mb-10 text-[#10b981] shadow-sm group-hover:bg-[#10b981] group-hover:text-white transition-all">
                <Mail size={24} />
              </div>
              <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">Email support</h4>
              <p className="text-xl font-bold text-slate-900 tracking-tight">info@optimumprints.shop</p>
            ...
            <div className="p-10 bg-slate-50 border border-slate-100 rounded-[2.5rem] group hover:bg-white hover:border-[#10b981]/20 transition-all duration-500">
              ...
              <p className="text-xl font-bold text-slate-900 tracking-tight leading-snug">437 N Illinois St, <br/> Indianapolis, IN 46204, United States</p>
              <div className="mt-6 flex items-center gap-2 text-[11px] font-bold text-[#10b981] uppercase tracking-wider">
                 <Globe size={12} />
          ...
          <div className="lg:col-span-8">
            <div className="bg-white border border-slate-100 p-8 md:p-16 rounded-[3rem] shadow-2xl shadow-slate-100">
              {status === 'success' ? (
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-16">
                  ...
                  <button onClick={() => setStatus(null)} className="px-10 py-4 bg-slate-950 text-white font-bold rounded-2xl hover:bg-[#10b981] transition-all">Send Another Message</button>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        className="w-full h-16 px-8 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[14px] font-bold text-slate-900 transition-all placeholder:text-slate-300 shadow-inner"
                      />
                    </div>
                    <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full h-16 px-8 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[14px] font-bold text-slate-900 transition-all appearance-none cursor-pointer shadow-inner"
                        >
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      className="w-full p-8 bg-slate-50 border border-slate-100 rounded-[2rem] focus:bg-white focus:border-[#10b981] outline-none text-[14px] font-bold text-slate-900 transition-all resize-none placeholder:text-slate-300 shadow-inner"
                    ></textarea>
                  </div>

                  <button
                    disabled={loading}
                    className="w-full h-16 bg-slate-950 text-white flex items-center justify-center gap-3 text-sm font-bold uppercase tracking-widest rounded-2xl hover:bg-[#10b981] transition-all disabled:opacity-50 group"
                  >
