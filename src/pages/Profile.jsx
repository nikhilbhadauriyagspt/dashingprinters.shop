    ...
    <div className="bg-white min-h-screen font-['Heebo'] text-slate-900 pb-20">
      ...
      <div className="bg-slate-50 border-b border-slate-100 py-12 md:py-16 mb-16">
        <div className="max-w-full mx-auto px-6 lg:px-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex items-center gap-2 px-5 py-2.5 bg-white text-[#10b981] rounded-2xl border border-slate-100 shadow-sm">
            <ShieldCheck size={18} />
                ...
                {[
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 px-6 py-4 text-[15px] font-bold transition-all rounded-2xl border ${activeTab === tab.id
                      ? 'bg-white text-[#10b981] border-[#10b981]/20 shadow-xl shadow-slate-100'
              ...
              {activeTab === 'profile' && (
                ...
                >
                  <div className="flex items-center gap-4 mb-16 pb-8 border-b border-slate-100">
                    <div className="h-14 w-14 bg-slate-50 text-[#10b981] flex items-center justify-center rounded-2xl">
                  ...
                  <form onSubmit={handleProfileUpdate} className="space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                      <div className="space-y-3">
                        ...
                        <input
                          ...
                          className="w-full h-16 px-8 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                        />
                      </div>
                      <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full p-8 bg-slate-50 border border-slate-100 rounded-[2.5rem] focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all resize-none shadow-inner"
                      ></textarea>
                    </div>
                    <button
                      disabled={isUpdating}
                      className="h-16 px-12 bg-slate-950 text-white font-bold text-sm uppercase tracking-widest rounded-2xl hover:bg-[#10b981] transition-all disabled:opacity-50 shadow-xl shadow-slate-200"
                    >
              ...
              {activeTab === 'orders' && (
                ...
                >
                  <div className="bg-white p-10 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-50 flex items-center justify-between">
                    ...
                    <Link to="/shop" className="text-xs font-black text-[#10b981] uppercase tracking-widest hover:underline">New Acquisition</Link>
                  </div>
                  ...
                  {orders.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      {orders.map((order) => (
                        <div key={order.id} className="bg-white border border-slate-100 rounded-[2.5rem] overflow-hidden group hover:border-[#10b981]/20 transition-all hover:shadow-2xl hover:shadow-slate-100">
                          ...
                          <div className="p-6 bg-slate-50 border-t border-slate-50">
                            <Link to="/orders" className="flex items-center justify-center gap-3 text-xs font-black text-slate-950 uppercase tracking-widest hover:text-[#10b981] transition-all group">
                  ...
                  <form onSubmit={handleSecurityUpdate} className="space-y-10">
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full h-16 pl-8 pr-16 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                        />
                        <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-6 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#10b981]">
                    ...
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        className="w-full h-16 pl-8 pr-8 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                      />
                    </div>
                    <button
                      disabled={isUpdating}
