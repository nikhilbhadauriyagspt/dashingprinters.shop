  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] font-['Rubik'] px-4 py-12">
      ...
      <div className="w-full max-w-[450px] bg-white rounded-3xl border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden">
        {/* Top Accent Bar */}
        <div className="h-2 bg-gradient-to-r from-[#1e1b4b] to-[#4f46e5]"></div>
        ...
        <div className="p-8 md:p-12">
            <div className="text-center mb-10">
                ...
                <h1 className="text-3xl font-bold text-[#1e1b4b] tracking-tight">Welcome Back</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    <div className="flex justify-between items-center px-1">
                        <label className="text-[13px] font-bold text-[#1e1b4b]">Password</label>
                    ...
                    <div className="relative group">
                        ...
                        <button
                            ...
                            className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#1e1b4b] transition-colors cursor-pointer"
                        >
                ...
                <button
                    disabled={loading}
                    className="w-full h-14 bg-[#1e1b4b] text-white rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-[#4f46e5] transition-all disabled:opacity-70 shadow-xl shadow-[#1e1b4b]/10 cursor-pointer flex items-center justify-center gap-3 active:scale-[0.98]"
                >
