      ...
      <div className="max-w-[1000px] w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-200">
        ...
        <div className="p-10 md:p-16 flex flex-col justify-center bg-white">
          <div className="mb-12">
            ...
            <p className="text-[11px] font-bold uppercase tracking-widest text-[#10b981]">Access your professional account</p>
          </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full h-16 pl-14 pr-6 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2.5">
                <div className="flex justify-between items-center px-1">
                  ...
                  <Link to="#" className="text-[10px] font-bold text-[#10b981] hover:underline uppercase tracking-widest">Forgot?</Link>
                </div>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full h-16 pl-14 pr-14 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                  />
                  <button
                    type="button"
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 text-center">
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">
              New to our platform?{' '}
              <Link to="/signup" className="text-[#10b981] hover:underline ml-1 font-black">Create account</Link>
            </p>
          </div>
        </div>
      </div>
