...
export default function UserSignup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 font-['Heebo'] px-6 py-20">
      ...
      <div className="max-w-[1000px] w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-200">
        ...
        <div className="hidden lg:flex flex-col justify-between p-16 bg-slate-950 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 mt-20">
            <div className="p-6 bg-white/5 border border-white/10 rounded-3xl flex items-center gap-4">
              <div className="h-12 w-12 bg-[#10b981]/20 rounded-2xl flex items-center justify-center text-[#10b981]">
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#10b981] opacity-10 blur-[100px] rounded-full pointer-events-none" />
        </div>
        ...
        <div className="p-10 md:p-16 flex flex-col justify-center bg-white">
          <div className="mb-12">
            ...
            <p className="text-[11px] font-bold uppercase tracking-widest text-[#10b981]">Register your professional profile</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2.5">
                ...
                <div className="relative group">
                  <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#10b981] transition-colors" size={18} />
                  <input
                    required
                    type="text"
                    ...
                    className="w-full h-16 pl-14 pr-4 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative group">
                  <Phone className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#10b981] transition-colors" size={18} />
                  <input
                    required
                    type="tel"
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                <Mail className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#10b981] transition-colors" size={18} />
                <input
                  required
                  type="email"
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative group">
                <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#10b981] transition-colors" size={18} />
                <input
                  required
                  ...
                  className="w-full h-16 pl-14 pr-12 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:border-[#10b981] outline-none text-[15px] font-bold text-slate-900 transition-all shadow-inner"
                />
                <button
                  type="button"
            ...
            <div className="pt-6">
              <button
                disabled={loading}
                className="w-full h-16 bg-slate-950 text-white flex items-center justify-center gap-3 text-sm font-bold uppercase tracking-widest rounded-2xl hover:bg-[#10b981] transition-all active:scale-95 disabled:opacity-70 group shadow-xl shadow-slate-200"
              >
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 text-center">
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">
              Already verified?{' '}
              <Link to="/login" className="text-[#10b981] hover:underline ml-1 font-black">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
