...
export default function PrivacyPolicy() {
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice for Intel Printing LLC ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="http://intelprinting.shop/">http://intelprinting.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories. Intel Printing Solutions provides a wide range of high-performance printers and printing accessories from leading technology brands.</li>
        <li>Engage with us in other related ways, including any marketing or events</li>
      </ul>
      <p>
        Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@intelprinting.shop">info@intelprinting.shop</a>.
      </p>
      ...
      <div className="bg-gray-50 p-8 rounded-sm border border-border my-12 not-prose">
        ...
        <ul className="text-sm text-gray-500 font-medium space-y-4 list-disc pl-5">
      ...
      <p><strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by PayPal, Visa and Master Card. You may find their privacy notice link(s) here: <a href="https://www.paypal.com/us/legalhub/paypal/privacy-full">PayPal</a>, <a href="https://www.visa.co.in/legal/global-privacy-notice.html">Visa</a> and <a href="https://www.mastercard.com/us/en/global-privacy-notice.html">Mastercard</a>.</p>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://intelprinting.shop/cookie-policy">http://intelprinting.shop/cookie-policy</a>.</p>
      ...
      <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://intelprinting.shop/cookie-policy">http://intelprinting.shop/cookie-policy</a>.</p>
      <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@intelprinting.shop">info@intelprinting.shop</a>.</p>
        ...
        <table className="w-full text-sm text-left text-gray-500 border border-border">
          ...
          <tbody className="text-gray-500 font-medium">
            ...
            <tr className="border-b border-border">
              ...
              <td className="px-6 py-4 border-r border-border">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individualâ€™s preferences and characteristics</td>
              <td className="px-6 py-4 text-black font-bold">NO</td>
            </tr>
            <tr>
      ...
      <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at info@intelprinting.shop, by visiting <a href="http://intelprinting.shop/contact">http://intelprinting.shop/contact</a>, or by referring to the contact details at the bottom of this document.</p>
      ...
      <h3>Appeals</h3>
      <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:info@intelprinting.shop">info@intelprinting.shop</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
      ...
      <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@intelprinting.shop">info@intelprinting.shop</a> or contact us by post at:</p>
